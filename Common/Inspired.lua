...
function goslib:SetupVars()
  ...
  MINION_ALLY, MINION_ENEMY, MINION_JUNGLE = GetTeam(myHero), 300-GetTeam(myHero), 300
  ...
  Smite = (summonerNameOne:lower():find("summonersmite") and SUMMONER_1 or (summonerNameTwo:lower():find("summonersmite") and SUMMONER_2 or nil))
  Exhaust = (summonerNameOne:lower():find("summonerexhaust") and SUMMONER_1 or (summonerNameTwo:lower():find("summonerexhaust") and SUMMONER_2 or nil))
