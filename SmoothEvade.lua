...
function SmoothEvade:Data()
	self.data = {
		...
		["Darius"] = {
			[_Q] = { name = "", speed = math.huge, delay = 0.75, range = 450, width = 450, type = "circular"},
			[_W] = { name = "", range = 275},
			[_E] = { name = "", speed = math.huge, delay = 0.32, range = 570, width = 125},
			[_R] = { name = "", range = 460}
		},
		["Diana"] = {
		...
		["MissFortune"] = {
			[_E] = { name = "", speed = math.huge, delay = 3.25, range = 800, width = 400, collision = false, aoe = true, type = "circular"},
